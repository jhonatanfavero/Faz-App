...
// =====================================================
// V40.1 - SUPER GABINETE (abas Banco / Rotinas / Notas)
// =====================================================
...
window.renderNotes = function() {
    ...
    if (notesDb.length === 0) {
        container.innerHTML = `
            <div class="text-center text-zinc-400 mt-6 px-4">
                <i class="ph ph-note-pencil text-4xl mb-2"></i>
                <p class="text-sm font-medium">Nenhuma nota ainda.</p>
                <p class="text-xs mt-1">Use o campo acima para anotar uma ideia, lembrete ou observação.</p>
            </div>`;
        return;
    }
